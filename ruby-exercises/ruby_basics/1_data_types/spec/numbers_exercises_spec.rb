# This is a really good template for test driven dev
# Make a .rb file in a spec folder
# import these two things
# RSpec.describe 'Title of Entire Test' do
#  describe 'Title of Specific Test' do
#  it "test case"
